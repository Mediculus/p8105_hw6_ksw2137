...
race). appears to be a reasonable compromise.
...
This is great since we see that our scatter plot seems to be centered at
0 without much variability. This means that our assumption of normality
holds.
